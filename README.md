...
```bash
git clone https://github.com/ghostaccess/proxera.git
cd proxera
```
...
5. Select the `ghostaccess/proxera` repository
...
wrangler pages deploy .vercel/output/static --project-name=proxera
```
...
- GitHub: [@ghostaccess](https://github.com/ghostaccess)
- Repository: [proxera](https://github.com/ghostaccess/proxera)
- Create an issue: [GitHub Issues](https://github.com/ghostaccess/proxera/issues)
## 🙏 Acknowledgments
